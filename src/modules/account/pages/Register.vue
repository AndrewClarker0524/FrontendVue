      ...
      <template v-else-if="stage === 'email_confirmation'">
        ...
        <div class="flex flex-col box white max-w-[304px]">
          ...
          >
            ...
            <button
              v-else
              class="logIn__form__input logIn__form__input_button block uppercase !bg-[#FFD54F]"
            ...
            <button
              class="logIn__form__input logIn__form__input_button block uppercase mb-[13px] !bg-[#4fff9e]"
              style="border-radius: 25px !important"
              type="submit"
            >
